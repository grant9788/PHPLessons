	...
	<body>
		...
		<form action="includes/signup.inc.php" method="POST">
			<?php
				...
				// Checking to see if any data was past from URL and if not will go into URL
				if (isset($_GET['first'])) {
					$first = $_GET['first'];
			...
			?>
			<!-- This is normal HTML becasue we dont want to keep data -->
